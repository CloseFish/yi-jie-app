          ...
          <main className="flex-1 p-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="relative">
                ...
                <div id="chatModal" className="fixed top-0 right-0 h-screen bg-[#E0EBE0] shadow-xl p-6 w-[480px] z-50 transition-all duration-300 transform translate-x-full flex flex-col">
                  ...
                  <div className="flex flex-col items-center gap-6">
                    ...
                    <div className="w-full space-y-4">
                      <div className="w-full h-12 bg-[#C2DBC2] rounded-lg flex items-center px-4">
                        ...
                        <div className="flex-1 h-2 bg-[#2D5A27]/20 rounded-full">
                          <div className="w-1/2 h-full bg-[#2D5A27] rounded-full"></div>
                        </div>
                      </div>
                      <div className="w-full h-12 bg-[#C2DBC2] rounded-lg flex items-center px-4">
                        <i className="fas fa-sun text-[#2D5A27] text-xl mr-4"></i>
                        <div className="flex-1 h-2 bg-[#2D5A27]/20 rounded-full">
                          <div className="w-3/4 h-full bg-[#2D5A27] rounded-full"></div>
                        </div>
                      </div>
                    </div>
                  </div>
