...
// 定义 RoomTemperatures 接口
interface RoomTemperatures {
	livingRoom: number;
	bedroom: number;
	study: number;
}

// 初始化 roomTemperatures 对象
const roomTemperatures: RoomTemperatures = {
	livingRoom: 26,
	bedroom: 25,
	study: 24,
};
...
const DevicePage: React.FC = () => {
	...
	const [selectedRoom, setSelectedRoom] = React.useState<keyof RoomTemperatures>('livingRoom');
	...
	const toggleDevice = (index: number, checked: boolean) => {
								...
								<Card key={index} className="p-8 bg-[#C2DBC2] border-none">
									<div className="flex items-center justify-between">
										...
										<Switch
											...
											onChange={(e) => toggleDevice(index, (e.target as HTMLInputElement).checked)}
										/>
									</div>
									<div className="mt-6">
							...
							<div className="space-y-6">
								...
								<div className="space-y-4">
									<div className="flex items-center justify-between">
										...
										<Switch
											checked={isTimerMode}
											onChange={(e) => setIsTimerMode((e.target as HTMLInputElement).checked)}
										/>
									</div>
									{isTimerMode && (
										<div className="grid grid-cols-3 gap-4">
